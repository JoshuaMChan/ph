const en = {
  ...
  school: {
    ...
    statisticalPhysics: 'Statistical Mechanics',
    ...
    microscopicMatter: 'Microscopic Matter Theory',
  ...
  schoolTag: {
    ...
    thermodynamics: 'France · Germany',
    statisticalPhysics: 'U.S. · Austria',
    relativity: 'Germany · U.S.',
    quantumMechanics: 'Europe · U.S.',
    quantumFieldTheory: 'U.S. · China',
    quantitativeChemistry: 'Britain · France',
    microscopicMatter: 'Britain · Italy',
    periodicTable: 'Russia',
    nuclearPhysics: 'Poland · New Zealand',
    quantumChemistry: 'U.S.',
    physiology: 'Europe',
    microbiology: 'Europe',
    evolution: 'Europe',
  ...
  place: {
    ...
    dole: 'Dole',
    marnesLaCoquette: 'Marnes-la-Coquette',
